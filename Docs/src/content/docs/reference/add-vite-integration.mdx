...
<Aside type="note">
You don't interact with these services directly — the [`dev-vite-scripts`](/reference/dev-vite-scripts)
and [`prod-vite-scripts`](/reference/prod-vite-scripts) tag helpers consume them for you.
</Aside>
