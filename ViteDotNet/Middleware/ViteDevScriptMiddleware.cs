...
internal static class ViteDevScriptMiddleware
{
        ...
        DiagnosticSource diagnosticSource, CancellationToken applicationStoppingToken)
    {
        ...
        var scriptRunner = new NodeScriptRunner(
            sourcePath, scriptName, envVars, "npm", diagnosticSource, applicationStoppingToken);
        ...
        catch (EndOfStreamException ex)
        {
            throw new InvalidOperationException(
                ...
                "Vite Dev Server had stopped. The error output was: " +
